...
global controls "age_woman age_woman_sq couple_age_diff i.educ_type i.couple_joint_religion i.raceth_fixed_woman i.couple_same_race i.marital_status_use couple_earnings_t1_ln i.moved_last_two weekly_hrs_t1_woman housework_t1_woman"
...
estimates save "$models/state_dummies_first_cons", replace

estimates use "$models/state_dummies_first_cons"
sum fertility_factor_det_t1, detail
...
* grayscale except for traditional
...
estimates save "$models/state_dummies_det_first_cons", replace
...
estimates use "$models/state_dummies_det_first_cons"
sum fertility_factor_det_t1, detail
...
// for broad: also add premarital births.

tab hh_hours_type housework_bkt, cell nofreq

/*
// I think this won't work with imputed data - follow what I did for life course
...
putexcel set "$results/First_birth_descriptives-cons", replace

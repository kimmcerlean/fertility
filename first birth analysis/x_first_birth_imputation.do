...
browse unique_id partner_id survey_yr marital_status_updated rel_start_yr rel_end_yr mh_yr_married1 mh_yr_end1 mh_yr_married2 mh_yr_end2 mh_yr_married3 mh_yr_end3 coh1_start coh1_end coh2_start coh2_end coh3_start rel1_start rel2_start rel3_start
gen marital_status_use = marital_status_updated
replace marital_status_use = 2 if marital_status_updated==. | marital_status_updated==3 // assume cohab since don't meet requirements for marriage

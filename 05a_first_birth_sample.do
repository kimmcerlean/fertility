...
browse unique_id partner_id survey_yr SEX SEX_sp weekly_hrs_t_focal weekly_hrs_t_sp housework_focal housework_sp _mi_m // the spouse HW estimation seems worse than focal. should I do BEFORE deduplicating and then rematch that info?
...
gen educ_type=.
replace educ_type=1 if inrange(educ_man,1,3) & inrange(educ_woman,1,3)
replace educ_type=2 if educ_man == 4 & inrange(educ_woman,1,3)
replace educ_type=3 if inrange(educ_man,1,3) & educ_woman == 4
replace educ_type=4 if educ_man == 4 & educ_woman == 4

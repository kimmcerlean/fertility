...
browse unique_id partner_id survey_yr rel_start_all marital_status_use relationship_duration time_since_first_birth had_second_birth joint_second_birth_opt2 joint_second_birth_yr
...
estimates save "$results/state_dummies_second_cons", replace

estimates use "$results/state_dummies_second_cons"
sum fertility_factor_det_t1, detail
